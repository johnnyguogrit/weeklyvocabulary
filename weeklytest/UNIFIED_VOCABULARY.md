...
> Passage: We Stretch our arms and legs first. Now we are ready to flip and do a perfect cartwheel.​
...
**Explanation:** 描述侧手翻特征。 • 第11/12周 (Stretch)​ ◦ 题干：To make your muscles long and warm, you should _______.​ ◦ 选项：A) Stretch B) stage C) character D) play​ ◦ 正确答案：A​ ◦ 答案解析：强化拉伸(Stretch)词汇。​ • 第12周末（综合复习测试：涵盖 cartwheel, Stretch）​ ◦ 阅读文本：We Stretch our arms and legs first. Now we are ready to flip and do a perfect cartwheel.​ ◦ 题干：Why do we stretch first?​ ◦ 选项：A) To fall down B) To get ready to do a cartwheel C) To sing a song D) To sleep​ ◦ 正确答案：B​ ◦ 答案解析：通过拉伸(Stretch)准备侧手翻(cartwheel)。​ 【第四阶段：第13-15周】​ • 第13/14周 (Stretch)​ ◦ 题干：If you feel tight, you need a good _______ to loosen up.​ ◦ 选项：A) cartwheel B) stretch C) lines D) emotions​ ◦ 正确答案：B​ ◦ 答案解析：针对紧绷状态需要拉伸。

---

**Week 15: review**

> Passage: We do a big cartwheel across the room. After moving fast, we sit down and Stretch our legs to cool down.​
...
**Explanation:** 下课冷却放松的步骤。 • 第15周末（综合复习测试：涵盖 stretch）​ ◦ 阅读文本：We do a big cartwheel across the room. After moving fast, we sit down and Stretch our legs to cool down.​ ◦ 题干：When do we stretch our legs?​ ◦ 选项：A) After moving fast B) Before sleeping C) While eating D) During a cartwheel​ ◦ 正确答案：A​ ◦ 答案解析：理解体育表演后的放松。
...
> Passage: Today we learn about time. An hour has 60 minutes. At 9 o'clock, we start class. At
half past 9, we practice math. We also learn to divide numbers and find the remainder.

**Question:** What do we do to the numbers in math class?

**Options:**
- A) hour B) o'clock C) divide D) half past

**Answer:** C

**Explanation:** ⽂本提到我们要对数字进⾏除法 divide 操作
...
> Passage: I have ten thousand points. You have less points than me. If we put our points
together, what is the total? First we add, not subtract. If we want to share them, we divide them
to see if there is a remainder.

**Question:** What do we do if we want to share the points equally?
...
**Explanation:** 均分/分享分数需要使⽤除法 divide
...
> Passage: During our growth, we become an adult. We look similar to our parents because we
inherit traits. But everyone has a different fingerprint on their hands.

**Question:** What is unique and not the same for every person?

**Options:**
- A) Adult B) Fingerprint C) Growth D) Diet

**Answer:** B

**Explanation:** 每个⼈的指纹 fingerprint 都是独⼀⽆⼆不同的
...
> Passage: At night, there is darkness. We look up and see a star. In the daylight, we can see
clearly. Inside the house, we use electricity to charge a toy robot and turn on a lamp.

**Question:** What power makes the toy robot move?

**Options:**
- A) Daylight B) Electricity C) Darkness D) A star

**Answer:** B

**Explanation:** 机器⼈的移动需要电 electricity
...
**Question:** A design that repeats shapes again and again is a _______.
...
**Explanation:** Pattern意为“模式/规律”

---

**Week 3: Caesar Cipher**

**Question:** A famous old code that shifts the alphabet letters is the _______.
...
**Explanation:** Caesar Cipher意 为“凯撒密码”

---

**Week 4: Symbol**

**Question:** A special sign like "@" or "#" used in a password is a _______.
...
**Question:** Using a strong password keeps your computer data in good _______.
...
**Explanation:** Security意为“安全”

---

**Week 5: review**

> Passage: We use a Computer for our project. It reads 0s and 1s, which is called Binary code. We
want to Encode a secret message with a Symbol for extra Security.

**Question:** What do we call the 0s and 1s code?

**Options:**
- A) Security B) Caesar Cipher C) Binary D) Symbol

**Answer:** C

**Explanation:** 0和1组成的代码是 Binary ⼆进制代码

---

**Week 7: Teamwork**

**Question:** Working nicely together with your group is good _______.
...
**Question:** A very hard problem that tests your skills is a _______.
...
**Question:** When you fix the problem, you have found the right _______.
...
**Explanation:** Solution意为“解决⽅案/答案”

---

**Week 9: Spreadsheet**

**Question:** A computer grid used to type and organize numbers is a _______.
...
**Question:** One small box inside the spreadsheet grid is called a _______.
...
**Explanation:** Cell意为“单元格”

---

**Week 10: Row**

**Question:** A straight line of boxes going from left to right is a _______.
...
**Question:** A straight line of boxes going up and down is a _______.
...
**Explanation:** Column意为“列”

---

**Week 11: Survey**

**Question:** Asking people questions to learn what they like is a _______.
...
**Explanation:** Survey意为“调查”

---

**Week 12: Question**

**Question:** To find an answer, you must first ask a _______.
...
**Explanation:** Question意为“问题”

---

**Week 12: Tally Mark**

**Question:** A small vertical line drawn to count answers quickly is a _______.
...
**Explanation:** Tally Mark意为“画记/计分符”

---

**Week 13: Data Analysis**

**Question:** Looking closely at the numbers to find a pattern is _______.
...
**Explanation:** Data Analysis意为“数据分 析”

---

**Week 13: Chart**

**Question:** A picture that shows data using colorful bars or lines is a _______.
...
**Explanation:** Chart意为“图表”

---

**Week 14: Most**

**Question:** The answer with the highest number of votes got the _______ votes.
...
**Explanation:** Most意为“最多的”

---

**Week 14: Least**

**Question:** The answer with the lowest number of votes got the _______ votes.
...
**Explanation:** Least意为“最少的”

---

**Week 15: review**

> Passage: After the Survey, we look at our Spreadsheet. We draw a colorful Chart for our Data
Analysis. Dogs got the Most votes. Now, our Project is done and we will Present it to the class!

**Question:** What do we do when we show and explain our project to the class?

**Options:**
- A) Chart it B) Present it C) Least it D) Encode it

**Answer:** B

**Explanation:** 向班级展⽰项⽬是 Present 汇报/展⽰
...
> Passage: We listen to the pulse of the song. In the first measure, we count to four. Then we
shake the tambourine (铃⿎) and strike the drum.

**Question:** What do we do to the drum to make a loud sound?

**Options:**
- A) Shake it B) Strike it C) Measure it D) Count it

**Answer:** B

**Explanation:** 敲击⿎使⽤的是 strike
...
> Passage: We rehearse our song and have good teamwork. We look at the teacher with full
focus. We sing with high energy to make a strong sound. The audience loves it and we bow on
the stage.

**Question:** What do we do to show we are paying attention to the teacher?

**Options:**
- A) Give a bow B) Lose energy C) Show full focus D) Make a gentle sound

**Answer:** C

**Explanation:** 注意⼒集中即表现出全神贯注 focus
...
> Passage: In our play, we stand tall with a straight back. We hold a magical wand in our hands.
Then we wave it and say a magic spell!

**Question:** What tool do we hold in our hands to do magic?

**Options:**
- A) A spell B) A wand C) A comedy D) A jump

**Answer:** B

**Explanation:** ⽤来变魔术的⼯具是魔杖 wand
...
> Passage: We act in a very funny comedy. It is very exciting! Every person plays a different
animal Character. The audience laughs and claps for us at the end of the show.

**Question:** Who laughs and claps at the end of the show?

**Options:**
- A) The Character B) The audience C) The comedy D) The wand

**Answer:** B

**Explanation:** 为表演⼤笑并⿎掌的是 audience 观众
...
> Passage: I read the dialogue in the script. I am playing a brave Character. In the game of hot
seating, you ask me a closed question and I can only answer "yes" or "no".

**Question:** What kind of question can only be answered with "yes" or "no"?

**Options:**
- A) A scene question B) A script question C) A closed question D) A hot seating question
...
**Question:** Please enter from _______ to start the scene.
...
**Explanation:** 巩固舞台⽅位词汇：舞台左侧

---

**Week 14: stage right**

**Question:** Walk across the stage and exit through _______.
...
**Explanation:** 巩固舞台⽅位词汇：舞台右侧

---

**Week 15: review**

> Passage: The actor walks to stage right with strong physicality. She shows a happy facial
expression and begins to speak her lines loudly.

**Question:** How an actor uses their body to move and show their character is their _______.

**Options:**
- A) lines B) stage left C) physicality D) script

**Answer:** C

**Explanation:** 使⽤⾝体动作来表现即为 physicality
...
> Passage: I look in the mirror to observe my face. I draw a self-portrait. I draw my nose as a key
feature. A big smile shows a happy feeling and a joyful expression.

**Question:** What drawing do I make by looking at myself in a mirror?

**Options:**
- A) A cube B) A self-portrait C) A feature D) A feeling

**Answer:** B

**Explanation:** 看着镜⼦画⾃⼰叫做⾃画像 self-portrait
...
> Passage: Today we do color mixing. We paint shapes that do not look like real life; it is abstract
art. The painting is a beautiful expression of joy.

**Question:** What kind of art uses shapes and colors but does not look like real things?

**Options:**
- A) A pattern B) Abstract art C) Mixing D) A self-portrait

**Answer:** B

**Explanation:** 不看起来像真实事物的艺术是抽象艺术 abstract
...
> Passage: We shout and cheer for our team! Good teamwork means helping each other
together. We use clear communication to talk, and we always trust and show respect to our
friends.

**Question:** What do we use to talk to each other clearly?

**Options:**
- A) Trust B) Respect C) Communication D) Cheer

**Answer:** C

**Explanation:** 清晰讲话需要良好的 communication 沟通
...
> Passage: Our team runs a fast lap for the passing relay race. We sprint to the finish line very fast
and win the gold medal!

**Question:** A race where teammates take turns passing a stick is a _______.

**Options:**
- A) save B) discus C) bounce D) relay

**Answer:** D

**Explanation:** 团队接⼒传递接⼒棒的⽐赛是接⼒赛 relay
...
> Passage: Today we learn big numbers. We know that 10 hundreds make one thousand. If we
...
**Options:**
- A) We subtract them. B) We divide them. C) We multiply them. D) We scale them.
...
> Passage: We have a garden shaped like a perfect square. To build a fence around it, we
...
**Options:**
- A) The area B) The perimeter C) The square D) The metre
...
> Passage: In math class, we learn how to calculate money. Money usually has a dot, so it is a
...
**Options:**
- A) A fraction B) A bar C) A decimal D) A graph
...
> Passage: There are many types of animals. Mammals have hair or fur and feed their babies
...
**Options:**
- A) Mammals B) Insects C) Reptiles D) Birds
...
> Passage: When you drop an apple, it falls down because of an invisible force called gravity.
...
**Options:**
- A) Weight B) Unit C) Gravity D) Fossil
...
> Passage: Metals are found in the earth. Gold is a very expensive yellow metal. Silver is a shiny
...
**Options:**
- A) Gold B) Silver C) Iron D) Aluminum
...
> Passage: In our code, we put a repeat block inside another repeat block. This is called a Nested
...
**Options:**
- A) A Sprite B) A Nested Loop C) A Motion Block D) A Stage
...
**Question:** A tiny pocket-sized computer board we use in class is a _______.
...
**Explanation:** micro:bit是⼀款微型电 脑主板
...
> Passage: On our computer screen, we use a virtual Simulator to test our code first. When we
...
**Options:**
- A) The Simulator B) The Input C) The LED Matrix D) The Physical Computing
...
> Passage: We build a rough, early model of our smart light called a Prototype. We ask our
...
**Options:**
- A) A Feedback B) A User Testing C) A Prototype D) A Sensor
...
> Passage: The song has a repeating rhythm pattern. When the same melody moves higher or
...
**Options:**
- A) A memory B) A sequence C) A pattern D) An articulation
...
> Passage: On the stage, sitting up straight with a tall back is having good posture. When you
...
**Options:**
- A) Good confidence B) Good stage presence C) Good posture D) Good follower
...
> Passage: After the big concert performance on the stage, we sit down to think about what we
...
**Options:**
- A) A performance B) A reflection C) A character D) Helpful feedback
...
> Passage: The wizards hold their magic wand up high. When the music starts, they do not move
...
**Options:**
- A) They fly B) They sleep C) They run in line D) They isolation
...
> Passage: The hero sees the bad guy. He does a Quiet, smooth run across the stage so no one
...
**Options:**
- A) He stares B) He sleeps C) He yells D) A quiet, smooth run
...
> Passage: It is time for the final magic battle on stage! The hero dodges the attack with a fast
...
**Options:**
- A) With a slow movement B) With a Swift movement C) By sleeping D) By a quiet stare
...
> Passage: To understand our Character better, we play a drama game called hot seating. You sit
...
**Options:**
- A) Stage direction B) Prop C) Hot seating D) Scene
...
> Passage: The school is putting on a big live play in the theater. My brother is the main actor. In
...
**Options:**
- A) A play B) A line C) A prop D) A tone of voice
...
**Question:** To walk to the back wall of the stage, you walk _______.
...
**Explanation:** 巩固词汇：向后⾛即为upstage

---

**Week 14: stage centre**

**Question:** The spotlight shines directly in the middle at _______.
...
**Explanation:** 巩固词汇：正中间即为stage centre

---

**Week 15: review**

> Passage: The actor uses strong physicality to move his body like a heavy monster. He walks
...
**Options:**
- A) Onstage B) Offstage C) Upstage D) Stage centre
...
> Passage: We look at historical art from the past. The Egyptians had a special painting style.
...
**Options:**
- A) A historical B) A style C) A profile D) A cave
...
> Passage: We are making art for Mother's Day. First, we do paper folding to make 3D flowers for
...
**Options:**
- A) A bouquet B) Paper folding C) A mosaic D) A skyline
...
**Question:** A clay bowl pops out and has real depth, so it is _______.
...
**Question:** A picture painted on a smooth wall is _______.
...
**Question:** A box is _______ because it is not just a drawing on paper.
...
**Explanation:** 巩固词汇：三维的

---

**Week 14: flat**

**Question:** A piece of printer paper is thin and _______.
...
> Passage: We use a wooden frame called a loom to hold the strings tight. We put colored yarn
...
**Options:**
- A) A texture B) A loom C) A weaving D) Glue
...
> Passage: To win the game, we need high motivation to try our best. We must use loud
...
**Options:**
- A) Motivation B) Communication C) Teamwork D) Respect
...
> Passage: In track and field, we run a long race and use good pacing so we are not tired. Next,
...
**Options:**
- A) Pacing B) Sprinting C) Bounce D) The shot put
...
> Passage: We line up for the team relay race. We wait for the whistle. Our reaction time is very
...
**Options:**
- A) A sprint B) A relay race C) A reaction time D) A cool-down
...
> Passage: In math class, we learn about numbers like 3.5. This is a decimal number. The small
...
**Question:** What do we do when we want to see if 4.2 is greater than 3.5?

**Options:**
- A) Compare them B) Add them C) Bracket them D) Divide them

**Answer:** A

**Explanation:** 判断哪个更⼤需要⽐较 compare 它们
...
> Passage: A tiny ant is only a few millimetres long. But our classroom is 10 metres long. If we
...
**Question:** What do we call the outside length around a garden?

**Options:**
- A) The area B) The perimeter C) The millimetre D) The bracket

**Answer:** B

**Explanation:** 围绕花园外部的⻓度称为周⻓ perimeter
...
> Passage: In our test, 1/2 is a fraction. If we want to write it with a dot like 0.5, we must convert
it. The number 0.5 is a decimal. Then we can easily compare 0.5 with other numbers to see
which is bigger.

**Question:** What do we do when we change the format from 1/2 into 0.5?

**Options:**
- A) We convert it B) We compare it C) We subtract it D) We round it

**Answer:** A

**Explanation:** 将1/2转换成0.5的形式，这个动作叫转换 convert
...
> Passage: We live on the hard outside layer called the Earth's crust. Under it is the hot mantle.
...
**Question:** What natural event causes the ground to shake violently?

**Options:**
- A) A crust B) A mantle C) An earthquake D) A habitat

**Answer:** C

**Explanation:** 导致地⾯剧烈震动的是地震 earthquake
...
> Passage: If there is no light, we are in the dark. Light can travel very fast in a straight line. When
it hits a shiny mirror, it will reflect back. The light then enters our eyes and allows us to see the
objects clearly.

**Question:** What happens when light hits a smooth, shiny mirror?

**Options:**
- A) It travels in a curve B) It absorbs C) It reflects D) It spins

**Answer:** C

**Explanation:** 光遇到镜⼦时会反弹/反射 reflect
...
> Passage: A round, ball-shaped model of the Earth is called a globe. Because of the Earth's
...
**Question:** What dark shape is created on the ground when an object blocks the sunlight?

**Options:**
- A) A globe B) A movement C) A length D) A shadow

**Answer:** D

**Explanation:** 阻挡光线在地⾯上产⽣的暗⾊形状是影⼦ shadow
...
> Passage: After typing numbers into our computer, we do our Data Analysis. We find the average
...
**Question:** What do we call the number that appears the most often in our data list?

**Options:**
- A) The Mean B) The Mode C) The Median D) The Format

**Answer:** B

**Explanation:** 列表中出现频率最⾼/最多次的数字称为众数 Mode

---

**Week 7: Research Question**
...
> Passage: On the internet, a powerful computer holding website data is the Server. Your
...
**Question:** What device helps direct the data to the correct place on the internet?

**Options:**
- A) A Server B) A Client C) A Router D) A Spreadsheet

**Answer:** C

**Explanation:** 帮助引导数据包路由到正确位置的设备是路由器 Router
...
> Passage: A good Network Design plans how all computers connect. We draw a map or Layout
...
**Question:** What do we call the ability of a network to easily grow larger?

**Options:**
- A) Scalability B) Security C) Layout D) Network Design

**Answer:** A

**Explanation:** ⽹络能够轻松扩⼤规模的能⼒被称为可扩展性 Scalability
...
> Passage: Every song expresses a unique musical idea. The main tune you sing along to is the
melody line. The notes go up and down, showing a melodic direction. Together, this creates a
beautiful musical shape.

**Question:** What do we call the main tune of the song that you sing along to?

**Options:**
- A) The shape B) The melody line C) The direction D) The idea

**Answer:** B

**Explanation:** 你可以跟着唱的歌曲的主要曲调称为主旋律 melody line
...
> Passage: To prepare for the concert, we use a good rehearsal technique, like playing slowly. If a
...
**Question:** What do we do to fix a mistake when a note sounds bad?

**Options:**
- A) Stage exit B) Problem solving C) Conductor cue D) Refine

**Answer:** B

**Explanation:** 解决糟糕⾳符的错误被称为解决问题 problem solving

---

**Week 11: musical character**
...
> Passage: After the big concert, we sit down to think about what we did well. This thinking time
...
**Question:** What do we call the thinking time where we look back at what we did well?

**Options:**
- A) Evaluate B) Goal C) Reflection D) Progress

**Answer:** C

**Explanation:** 回想⾃⼰做得好的思考时间称为反思 reflection
...
> Passage: In the musical, the actor plays a poor pauper. To look confident, he must keep a tall,
...
**Question:** What kind of movement does the actor make to dance on the beat?

**Options:**
- A) A slow walk B) A sharp quick movement C) A quiet sit D) A sleeping pose

**Answer:** B

**Explanation:** 演员伴随节拍做出⼲脆迅速的动作 sharp quick movement
...
**Question:** Slouching your shoulders is an example of bad stage _______.
...
**Explanation:** 巩固词汇：posture

---

**Week 8: character connection**
...
**Question:** Keep your _______ high so the audience feels you are looking at them.
...
**Explanation:** 巩固词汇：Eyeline

---

**Week 9: posture**

**Question:** A king on stage will stand with a very proud and tall _______.
...
**Week 9: character connection**

**Question:** Looking at your partner and reacting to their lines builds good _______.

**Options:**
- A) lyrics
- B) character connection
- C) knee slides
- D) gruel

**Answer:** B

**Explanation:** 巩固 词汇：character connection

---

**Week 9: naughty**

**Question:** The _______ student threw a paper airplane at the teacher.
...
**Explanation:** 巩固词汇：naughty

---

**Week 10: review**

> Passage: The actor plays a naughty student. She stands with a slouchy posture to look lazy.
She keeps her Eyeline looking at the floor. But when she talks to her best friend, they show a
strong character connection.

**Question:** What kind of posture does the naughty student use to look lazy?

**Options:**
- A) A tall posture B) A proud posture C) A slouchy posture D) A stiff posture

**Answer:** C

**Explanation:** 懒散的姿势是 slouchy posture

---

**Week 11: work together**
...
**Week 12: work together**

**Question:** Actors must _______ to move the heavy props quickly.
...
**Explanation:** 巩固词汇：work together

---

**Week 12: connect as a group**

**Question:** Trusting each other helps the cast to _______.
...
**Explanation:** 巩固词汇：connect as a group

---

**Week 12: show off**

**Question:** The singer sang a very high note to _______ her beautiful voice.
...
**Explanation:** 巩固词汇：show off

---

**Week 12: mischievous**

**Question:** The _______ monkey stole the zookeeper's hat.
...
**Explanation:** 巩固词汇：mischievous

---

**Week 13: work together**

**Question:** If we _______, we can finish learning the new song faster.
...
**Week 13: connect as a group**

**Question:** Listening to everyone's ideas helps us _______.
...
**Question:** It is fun to _______ your cool new costume on stage.
...
**Week 14: work together**

**Question:** A good team will always _______ to solve a hard problem.
...
**Week 14: connect as a group**

**Question:** Before the show, the actors breathe together to _______.

**Options:**
- A) fight
- B) connect as a group
- C) sleep
- D) steal
...
**Question:** The dancer did a big jump to _______ to the audience.
...
**Question:** A _______ smile means you are about to do something tricky.
...
> Passage: The monkeys in the play are very mischievous. They love to play tricks on everyone.
...
**Question:** What word describes the monkeys that love to play tricks?

**Options:**
- A) Sad B) Mischievous C) Angry D) Tired

**Answer:** B

**Explanation:** 喜爱恶作剧的猴⼦是淘⽓的 mischievous
...
> Passage: To understand our character better, we play a game called hot seating. We sit in a
...
**Options:**
- A) A closed question B) An open question C) A hot seating D) A character
...
**Question:** The superhero answered questions during a fake _______.
...
**Explanation:** 巩固词汇：press conference
...
**Question:** The actor stayed in _______ and refused to use his real name.
...
**Explanation:** 巩固词汇：character

---

**Week 7: open question**
...
**Question:** The _______ put on his costume and waited to go on.
...
**Explanation:** 巩固词汇：actor

---

**Week 8: character**

**Question:** Batman is a famous comic book _______ played by real people.
...
**Question:** Memorizing the _______ is important so you know what to say.
...
**Question:** The _______ speaks loudly so the audience can hear.
...
**Question:** The first _______ takes place in a spooky forest.
...
> Passage: Tonight is the big school play. The main actor is nervous. Before the first scene starts,
he grabs his magic wand, which is a very important prop for his role.

**Question:** What object does the actor hold in his hand?

**Options:**
- A) A play B) A prop C) A scene D) An actor

**Answer:** B

**Explanation:** 演员⼿中的物品称为道具 prop
...
**Question:** If an actor looks out at the crowd and moves to his left arm, he goes _______.
...
**Explanation:** 巩固词汇：stage left

---

**Week 14: stage right**

**Question:** If an actor looks out at the crowd and moves to his right arm, he goes _______.
...
**Explanation:** 巩固词 汇：stage right

---

**Week 14: upstage**

**Question:** If a prop is placed in the very back of the stage, it is placed _______.
...
**Explanation:** 巩固词汇：upstage

---

**Week 14: downstage**

**Question:** If an actor wants to sit near the front row of people, he goes _______.
...
**Explanation:** 巩固词汇：downstage

---

**Week 15: review**

> Passage: The director creates the blocking, telling everyone exactly where to stand. The actor
...
**Question:** What is the plan of where actors stand and move called?

**Options:**
- A) Offstage B) Blocking C) Onstage D) Movement

**Answer:** B

**Explanation:** 导演安排演员站位和⾛位的计划称为⾛位 blocking
...
> Passage: The artist starts with a small shape called a motif. By repeating it, she creates a
...
**Question:** What do we call a small, single shape that gets repeated?

**Options:**
- A) A pattern B) A motif C) A layout D) A border

**Answer:** B

**Explanation:** 被重复的⼀个⼩⽽单⼀的形状/图案称为 motif
...
**Question:** Ancient Chinese _______ values beautiful writing very much.
...
**Explanation:** 巩固词汇：culture

---

**Week 9: calligraphy**

**Question:** The artist used black ink to practice Chinese _______.
...
**Explanation:** 巩固词汇：calligraphy

---

**Week 10: review**

> Passage: In ancient Chinese culture, writing beautifully is a very important tradition. This art is
called calligraphy. The master shows the student how to use the brush to make a perfect black
ink stroke on the paper.

**Question:** What is the art of writing beautifully with a brush called?

**Options:**
- A) Origami B) A stroke C) Calligraphy D) A tradition

**Answer:** C

**Explanation:** ⽤⽑笔优美书写的艺术是书法 calligraphy

---

**Week 11: paper cutting**
...
**Question:** We made a beautiful butterfly using the _______ technique.
...
**Question:** I need to use _______ to cut this thick paper.
...
**Question:** It is fun to _______ colorful paper into tiny pieces for a mosaic.
...
**Explanation:** 巩固词汇：tear

---

**Week 14: trim**

**Question:** You should _______ the long thread so it looks tidy.
...
**Explanation:** 巩固词汇：trim

---

**Week 15: review**

> Passage: To make an amazing movie poster, we draw a quick sketch first. We study typography
...
**Question:** What is a quick, rough pencil drawing called?

**Options:**
- A) A sketch B) A layout C) Typography D) A font design

**Answer:** A

**Explanation:** 快速粗糙的铅笔画被称为草图 sketch
...
**Options:**
- A) Motivation B) Communication C) Teamwork D) False start

**Answer:** C

**Explanation:** 在⽐赛中帮助朋友体现了极好的团队合作 teamwork
...
> Passage: At the track meet, runners use good pacing for long races. They take a long stride to
run faster. Next, a thrower pushes the heavy metal ball for the shot put. On the court, players
bounce the basketball.

**Question:** What event uses a heavy metal ball?

**Options:**
- A) A stride B) Pacing C) A bounce D) The shot put

**Answer:** D

**Explanation:** 推沉重⾦属球的运动是推铅球 shot put
...
> Passage: We are ready for the team relay race. We wait for the whistle. Because of our fast
...
**Question:** What describes how quickly we start moving when the whistle blows?

**Options:**
- A) A sprint B) A relay race C) Our reaction time D) A spin

**Answer:** C

**Explanation:** 描述听到哨声后开始移动的速度是反应时间 reaction time
...
> Passage: In math class, we learn how to share 12 apples equally among 3 friends. Because 12 is
...
**Question:** Why can we easily share 12 apples equally among 3 friends?

**Options:**
- A) Because 12 is a fraction B) Because 12 is divisible by 3 C) Because 12 is a cube D)

**Answer:** B

**Explanation:** 因为12可以被3整除 divisible

---

**Week 7: common factor**
...
> Passage: Today we learn about math division. When we divide a whole pizza into 4 equal slices,
each slice is exactly the same size. If you eat one slice, you have eaten a fraction of the pizza,
which is 1/4.

**Question:** What must the slices be like when we divide a whole pizza into a fraction?

**Options:**
- A) They must be improper B) They must be equal in size C) They must be a multiple D)

**Answer:** B

**Explanation:** 分成等份的⽚段必须⼤⼩相等 equal
...
> Passage: In our final math review, we look at different topics. A fraction shows part of a whole.
...
**Question:** Which tool do we use to show how temperatures change over time?

**Options:**
- A) A fraction B) A volume C) A line graph D) A factor

**Answer:** C

**Explanation:** ⽤折线图 line graph 可以展⽰随时间变化的数据趋势
...
> Passage: We need food to give us energy to fight against the force of gravity when we jump.
...
**Question:** Which organ is part of the digestive system mentioned in the text?

**Options:**
- A) Gravity B) The stomach C) A force D) A vitamin

**Answer:** B

**Explanation:** ⽂中提到属于消化系统的器官是胃 stomach
...
> Passage: There are many types of force in science. Gravity pulls things down. A magnet can pull
...
**Question:** What force pushes you up when you are swimming in water?

**Options:**
- A) Gravity B) Friction C) A magnet D) Upthrust

**Answer:** D

**Explanation:** 在⽔中向上推并帮助漂浮的⼒是浮⼒ upthrust
...
> Passage: Living things adapt to their environment. In rainy or snowy weather, plants and
...
**Question:** What special part does a rose bush grow to protect itself?

**Options:**
- A) A gill B) A fin C) A thorn D) The weather

**Answer:** C

**Explanation:** 玫瑰丛⻓出⽤来保护⾃⼰的特殊部位是刺 thorn
...
> Passage: When designing a video game, we first draw a Flowchart to map out the logic. We
...
**Question:** What is the drawing used to map out the logic of the game called?

**Options:**
- A) A Variable B) A Score C) A Flowchart D) An Initialization
...
> Passage: To track climate change, data must be highly Organized. A space Satellite takes
...
**Question:** Who is a regular person that helps report data for scientific research?

**Options:**
- A) A Satellite B) A Weather Station C) A Citizen Scientist D) A Collection Method

**Answer:** C

**Explanation:** 协助收集科学数据的普通⺠众称为公⺠科学家 Citizen Scientist
...
> Passage: We feed our temperature numbers into a computer Data System. Then, we perform a
...
**Question:** What do we call the slides and visuals we create to show our research to the class?

**Options:**
- A) An Analysis B) A Forecast C) A Presentation D) A Data System

**Answer:** C

**Explanation:** 向班级展⽰研究成果的幻灯⽚和视觉效果被称为演⽰/汇报展⽰ Presentation

---

### Subject: Music

**Week 2: soprano recorder**
...
> Passage: To sing well in the choir, we must practice hard. We keep a straight posture alignment
...
**Question:** What muscle do we use to push the air when singing?

**Options:**
- A) The heart B) The brain C) The diaphragm D) The stamina

**Answer:** C

**Explanation:** 唱歌时推动空⽓的肌⾁是横膈膜 diaphragm

---

**Week 7: timing moment**
...
> Passage: During the rehearsal process, we practice our songs many times. If the harmony
...
**Question:** What do we call it when we practice a part of the song over and over to fix it?

**Options:**
- A) Improvement B) Repeat section C) Rehearsal process D) Refine

**Answer:** B

**Explanation:** 将歌曲的⼀部分练习很多次以修复它被称为重复段落 repeat section

---

**Week 11: musical phrasing**
...
> Passage: After the amazing concert, the choir sits down for some quiet reflection. We share a
...
**Question:** What do we do to talk about what we did well and what we can fix?

**Options:**
- A) A celebration B) An achievement C) A critique D) A growth

**Answer:** C

**Explanation:** 讨论优缺点并提出修改意⻅的过程被称为评论/点评 critique
...
**Question:** In the play, the _______ have to sing in the dirty streets.
...
**Explanation:** 巩固词汇：poor people

---

**Week 4: revolution**

**Question:** The red flag waving in the air is a symbol of the _______.
...
> Passage: In the sad scene, the town's people are very miserable because they are hungry. The
...
**Question:** What do the actors do to show their strong feelings to the crowd?

**Options:**
- A) They smile happily B) They sleep C) They sing D) They hide

**Answer:** C

**Explanation:** 演员们通过唱歌 sing 向⼈群展⽰他们强烈的情感
...
> Passage: Playing the villain is fun. First, I use my memories to truly feel angry. Then I tense my
...
**Question:** What does the actor do with his muscles and posture to show his rage?

**Options:**
- A) Stand angry B) Sound angry C) Sing angry D) Feel happy

**Answer:** A

**Explanation:** 运⽤肌⾁和姿势来展现愤怒即为站出愤怒的姿态 stand angry
...
**Question:** If you mumble into your chest, you fail to _______ your words clearly.
...
**Explanation:** 巩固词汇：project

---

**Week 14: feel**

**Question:** The best acting happens when you _______ the moment as if it is 100% real.
...
**Explanation:** 巩固词汇：feel

---

**Week 14: eye contact**

**Question:** Two actors locking eyes in complete silence is a powerful moment of _______.
...
**Question:** Even when acting like you are whispering, you must _______ so everyone hears the secret.
...
**Week 14: eyeline lifted**

**Question:** To show extreme pride and confidence, the king walks to the throne with his _______.
...
**Explanation:** 巩固词汇：eyeline lifted

---

**Week 15: review**

> Passage: In the final show, the actor must truly feel the character's heart. He must maintain
...
**Question:** What must the actor do to ensure his voice is loud enough for everyone to hear?

**Options:**
- A) Keep his eyeline lifted B) Feel the heart C) Project his voice D) Make eye contact

**Answer:** C

**Explanation:** 为了确保声⾳⾜够⼤能被听⻅，演员必须发声/投射 project 他的声⾳
...
> Passage: To make our art interesting, we start by drawing a straight line. A vertical mark goes
...
**Question:** What kind of mark goes straight from left to right across the page?

**Options:**
- A) A vertical mark B) A horizontal mark C) A diagonal mark D) A focal point

**Answer:** B

**Explanation:** 从左到右横跨⻚⾯的线条是⽔平的 horizontal
...
> Passage: Before making a 3D artwork, an artist writes a paper Proposal to explain their idea.
...
**Question:** What is the artwork called when you build it by gluing different 3D scrap objects
together?

**Options:**
- A) A Sketch B) An Assemblage C) A Proposal D) A Volume
...
> Passage: Op Art is a very cool style of painting. It plays tricks on your eyes, creating an Optical
...
**Question:** What do artists use to play tricks on your eyes and make the paper look like it is moving?

**Options:**
- A) A Label B) An Optical Illusion C) An Exhibition D) A Palette

**Answer:** B

**Explanation:** 让平⾯的纸看起来像在移动的视觉戏法被称为视错觉 Optical Illusion
...
> Passage: To win a difficult challenge, players need high motivation to run fast. Good
...
**Question:** What helps players talk to each other and pass the ball perfectly?

**Options:**
- A) Good communication B) A false start C) A photo finish D) A hurdle

**Answer:** A

**Explanation:** 帮助队员互相交谈并完美传球的是良好的沟通 communication
...
> Passage: In the running race, using good pacing helps you not get tired too fast. You must take
...
**Question:** What helps a runner not get tired too fast during a long race?

**Options:**
- A) Good pacing B) Deception C) A shot put D) A bounce

**Answer:** A

**Explanation:** 在⻓跑中不⾄于太快疲劳的⽅法是良好的配速 pacing
...
> Passage: In a team relay race, runners pass a baton to each other. When the whistle blows, a
...
**Question:** What helps a runner start moving instantly when the whistle blows?

**Options:**
- A) A spin B) A fast reaction time C) A relay race D) A base position

**Answer:** B

**Explanation:** 帮助跑者在吹哨时瞬间起跑的是快速的反应时间 reaction time
